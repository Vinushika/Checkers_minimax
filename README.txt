...
Given how poorly our randomized move generator was going, even when it disfavored draws, we switched to heuristic scoring that favors having more pieces than the opponent and values pieces further up the board more than pieces at the back of the board.
